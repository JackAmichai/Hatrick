        ...
        <div className={`w-full h-screen ${bgClass} ${textClass} overflow-hidden relative transition-colors duration-500`}>
            ...
            <div className="relative z-10 h-full flex flex-col">
                ...
                >
                    ...
                    {/* Developer Credit */}
                    <div className={`inline-flex items-center gap-3 px-4 py-2 rounded-lg ${isDarkMode ? 'bg-white/5 border border-white/10' : 'bg-black/5 border border-black/10'} backdrop-blur-sm`}>
                        <div className="flex flex-col items-start">
                            <p className={`text-xs font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                                Built by Jack Amichai
                            </p>
                            <p className="text-[10px] text-gray-500 font-mono">
                                AI Engineer @ Deloitte • Full-Stack Dev • Cybersecurity Enthusiast
                            </p>
                        </div>
                        <a 
                            href="https://www.linkedin.com/in/jack-amichai" 
                            target="_blank" 
